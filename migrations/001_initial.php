...
return [
	"up" => [
		...
		"CREATE TABLE reserved_rooms(id INT not null primary key auto_increment,room_id INT not null,reservation_id INT not null,check_in_datetime DATETIME,check_out_datetime DATETIME);",
